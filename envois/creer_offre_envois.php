...
<body>
    <?php
        ...
        if(isset($_POST['creer_offre'])){
          ...
          $requete = "INSERT INTO offre_emplois(date_limite, description, id_personne, libelle, video, lieu, salaire, type_contrat, supprimer) VALUES ('$dateLimite', '$description', $idPersonne, '$lib', '$video', '$lieu', $salaire, '$contrat', 0)";
